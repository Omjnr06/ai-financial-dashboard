...
export function SearchAskChatTile({ onOpenChat }: SearchAskChatTileProps) {
  return (
    <div
      ...
      className="bg-accent/20 border border-accent/40 rounded-3xl p-6 flex items-center justify-between cursor-pointer group min-h-30 transition-all duration-300 ease-out hover:-translate-y-1.5 hover:translate-x-1.5 hover:shadow-2xl hover:shadow-accent/10 hover:border-accent hover:bg-accent/30"
    >
      <div>
